...
// CapabilityReport is advertised by a Fastlet after probing the actual node
// and initializing its selected RuntimeDriver.
...
// CapabilityProber validates host dependencies before a driver is created.
