...
This overlay is the development and compatibility deployment shape for running
...
Changing an existing split deployment to all-in-one therefore requires an
explicit, reviewed migration operation for the old FastPath Deployment/HPA/PDB;
